...
function loadLibrary(e) {
    ...
    ipcRenderer.send("dir:select", { prop: "example" });
}
...
ipcRenderer.on("dir:selected", (dir) => {
    console.log("DIR SELECTED: ", dir);
    alertSuccess(`Directory selected`);
});
...
dirs.addEventListener("click", loadLibrary);
